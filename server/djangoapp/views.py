...
def get_dealerships(request):
    if request.method == "GET":
        context = {}
        url = "https://sonypatangay-3000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get"
        # Get dealers from the Cloudant DB
        context["dealerships"] = get_dealers_from_cf(url)
        print(f"result got {context}")
...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://sonypatangay-5000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/get_reviews?id=13'
...
def add_review(request, dealer_id):
    ...
    if request.user.is_authenticated:
        ...
        if request.method == "GET":
            url = f"https://sonypatangay-3000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get?dealerId={dealer_id}"
        ...
        if request.method == "POST":
            ...
            url = "https://sonypatangay-5000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/review"  # API Cloud Function route
